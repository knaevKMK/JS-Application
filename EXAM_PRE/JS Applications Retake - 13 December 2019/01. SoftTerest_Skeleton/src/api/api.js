...
export async function login(email, password) {
    const response = await post('https://baas.kinvey.com/user/kid_HkzTFA44O/login', ({ 'username': email, 'password': password }));
...
export async function register(email, password) {
    const response = await post('https://baas.kinvey.com/user/kid_HkzTFA44O/', ({ 'username': email, 'password': password }));
    _setSession(response);
    return response;
}
//Work logout
export async function logout() {
    return await post('https://baas.kinvey.com/user/kid_HkzTFA44O/_logout');
}
//====================================================================