...
function getOptions(method, body) {
    const options = {
        method,
        headers: {
            'Authorization': `Basic ${btoa('kid_Hylxjsd4_:3d1e261f1b264f7598c061a862c45fd7')}`,
...
export async function login(email, password) {
    const response = await post('https://baas.kinvey.com/user/kid_Hylxjsd4_/login', ({ 'username': email, 'password': password }));
...
export async function register(email, password) {
    const response = await post('https://baas.kinvey.com/user/kid_Hylxjsd4_/', ({ 'username': email, 'password': password }));
    _setSession(response);
    return response;
}
//Work logout
export async function logout() {
    return await post('https://baas.kinvey.com/user/kid_Hylxjsd4_/_logout');
}
//====================================================================